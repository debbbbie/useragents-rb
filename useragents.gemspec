Gem::Specification.new do |s|
  ...
  s.files         = ['useragents.gemspec', 'lib/useragents.rb', 'lib/core_ext/blank.rb', 'lib/useragents/fetch.rb', 'lib/useragents/useragents.dat', 'spec/useragents_spec.rb', 'README.md', 'LICENSE']
